...
class Pages extends Component
{
    ...
    protected array $rules = [
        ...
        'settings.page_shipping_title' => 'required|string|max:255',
        'settings.page_shipping_content' => 'required|string',
    ...
    {
        $this->validate([
            'settings.page_shipping_title' => $this->rules['settings.page_shipping_title'],
            'settings.page_shipping_content' => $this->rules['settings.page_shipping_content'],
        ]);

        $this->persistSettings(['page_shipping_title', 'page_shipping_content']);

        session()->flash('message', 'Shipping info saved successfully.');
    }
