        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <aside class="w-full lg:w-64 flex-shrink-0 space-y-8">
                <form method="GET" action="{{ route('store.search') }}">
                    ...
                    <div x-data="{ open: false }" class="bg-white p-5 rounded-lg shadow-sm border border-gray-200 lg:hidden">
                    ...
                    <div x-data="{ open: false }" class="bg-white p-5 rounded-lg shadow-sm border border-gray-200">
                        <button type="button" @click="open = !open" class="flex w-full items-center justify-between lg:pointer-events-none lg:cursor-default">
                        ...
                        <div class="mt-4 lg:mt-0" :class="open ? 'block' : 'hidden lg:block'">
                            <div class="space-y-4">
                ...
                <div x-data="{ expanded: false }" class="bg-white p-5 rounded-lg shadow-sm border border-gray-200">
                    <button type="button" @click="expanded = !expanded" class="flex w-full items-center justify-between lg:pointer-events-none lg:cursor-default">
                        <div class="flex items-center gap-2">
                    ...
                    <div class="mt-4 lg:mt-0" :class="expanded ? 'block' : 'hidden lg:block'">
