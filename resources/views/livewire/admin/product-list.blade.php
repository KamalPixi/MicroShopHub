            ...
            <tbody>
                ...
                <tr class="border-t">
                    ...
                    <td class="text-end space-x-1">
                        <!-- View -->
                        <a href="{{ route('admin.products.show', $product->id) }}" class="inline-flex items-center py-1 text-blue-600 hover:text-blue-800 rounded">
                        ...
                        <!-- Edit -->
                        <a href="{{ route('admin.products.edit', $product->id) }}" class="inline-flex items-center py-1 text-green-600 hover:text-green-800 rounded">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
