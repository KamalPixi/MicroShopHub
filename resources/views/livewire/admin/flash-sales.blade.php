                    ...
                    @forelse($flashSales as $sale)
                        <tr class="border-t">
                            ...
                            <td class="p-2 text-end space-x-2">
                                <button wire:click="edit({{ $sale->id }})" class="text-xs font-semibold text-primary hover:underline">Edit</button>
                                <button wire:click="delete({{ $sale->id }})" wire:confirm="Delete this flash sale?" class="text-xs font-semibold text-red-600 hover:underline">Delete</button>
                            </td>
                        </tr>
                    @empty
                        <tr>
