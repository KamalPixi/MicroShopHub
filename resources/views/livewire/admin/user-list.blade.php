<div class="bg-white p-4 rounded-lg shadow table-container mx-auto">
    <div class="flex justify-between">
        ...
        <div>
            <a href="{{ route('admin.users.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 text-sm flex items-center">
    ...
    <div class="mb-4">
        <label for="search" class="block text-sm font-medium text-gray-700">Search Admin Users</label>
        <input 
            ...
            <tbody>
                @forelse ($admins as $admin)
                    <tr class="border-t">
                        ...
                        <td class="p-2">{{ $admin->created_at->format('Y-m-d H:i') }}</td>
                        <td class="p-2 text-end space-x-1">
                            <!-- View -->
                            <a href="{{ route('admin.users.show', ['user_id' => $admin->id]) }}" class="inline-flex items-center py-1 text-blue-600 hover:text-blue-800 rounded" title="View">
                            ...
                            <!-- Edit -->
                            <a href="{{ route('admin.users.edit', ['user_id' => $admin->id]) }}" class="inline-flex items-center py-1 text-green-600 hover:text-green-800 rounded" title="Edit">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <button 
                                ...
                                wire:confirm="Are you sure you want to delete this admin user?" 
                ...
                @empty
                    <tr>
                        <td colspan="5" class="text-center text-gray-500 py-4">No admin users found.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
