                            ...
                            <div class="border border-gray-200 rounded-lg p-3">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="flex items-center gap-2">
                                        @if($payment->attachment_path)
                                            <a href="{{ Storage::url($payment->attachment_path) }}" target="_blank" class="text-xs text-primary hover:underline font-bold flex items-center gap-1">
                                ...
                                @if($payment->status === 'pending')
                                    <div class="mt-3 flex items-center gap-2">
                                        <button type="button" wire:click="approveOfflinePayment({{ $payment->id }})" wire:confirm="Approve this offline payment?" class="admin-action-btn admin-action-success" title="Approve">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                                            </svg>
                                        </button>
                                        <button type="button" wire:click="rejectOfflinePayment({{ $payment->id }})" wire:confirm="Reject this offline payment?" class="admin-action-btn admin-action-delete" title="Reject">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
