<div class="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
    <div class="flex items-start justify-between gap-3">
        <div>
            <p class="text-xs font-semibold uppercase tracking-[0.24em] text-primary">Contact form</p>
    ...
    <form wire:submit.prevent="submit" class="mt-6 space-y-4">
        ...
        <div class="grid gap-4 md:grid-cols-2">
            ...
            <div>
                <label class="block text-sm font-semibold text-gray-700">Subject <span class="text-red-500">*</span></label>
